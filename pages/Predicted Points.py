...
def construct_team_and_player_data(
    ...
    for fixture in fixtures_24_25:
        ...
        home_raw_home_weight_25_26 = 2 / team_data[home_team_name]['25/26 Home Games Played'] if team_data[home_team_name]['25/26 Home Games Played'] != 0 else 0
        ...
        away_raw_away_weight_25_26 = 2 / team_data[away_team_name]['25/26 Away Games Played'] if team_data[away_team_name]['25/26 Away Games Played'] != 0 else 0
